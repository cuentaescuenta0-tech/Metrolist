...
internal object EchoBrainQueuePlanner {
        ...
        return candidates
            ...
            .filter { candidate ->
                radioSimilarityScore(
                    ...
                    (!strictAffinity || hasExplicitRadioRelation(
                        candidate,
                        seedArtists,
                        seedAlbum,
                        momentArtistIds,
    ...
    private fun radioSimilarityScore(
        ...
        // Radio remains neutral to release year. A radio candidate has a conservative 60% base
        // because its source is already related; higher modes still require explicit signals.
        var score = 60
